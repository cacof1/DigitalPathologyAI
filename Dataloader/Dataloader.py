...
class DataGenerator(torch.utils.data.Dataset):
    def __init__(self, coords_file, wsi_file, dim=(256, 256), vis_level=0, inference=False, transform=None,
                 target_transform=None, target="tumour_label"):
        super().__init__()
    ...
    for filenb,file_id in enumerate(ids):
        try:
            ...
            if fractional_data<1:
                coords = coords.sample(frac=fractional_data, random_state=21)

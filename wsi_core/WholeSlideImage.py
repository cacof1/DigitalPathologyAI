...
import pdb
import math
from wsi_core.wsi_utils import coord_generator, sample_indices, screen_coords, isBlackPatch, isWhitePatch, \
    to_percentiles
import itertools
...
class WholeSlideImage(object):
    ...
    def visHeatmap(self, scores, coords, vis_level=-1,
        ...
        Args:
            ...
            return_overlay (bool): wether to return the overlay map in itself (as a numpy array) or not.
        ...
        if return_overlay:
            return img, overlay  # np.stack(overlay, axis=0)
        else:
            return img, None

    ...
    for nb,slide in enumerate(source):
        ...
        if vis_params['vis_level'] < 0:
            if len(WSI_object.level_dim) == 1:
                ...
                if(best_level >= len(WSI_object.level_dim)): vis_params['vis_level'] = len(WSI_object.level_dim) - 1
                else: vis_params['vis_level'] = best_level
        ...
        if seg_params['seg_level'] < 0:
            if len(WSI_object.level_dim) == 1:
                ...
                best_level =  WSI_object.wsi.get_best_level_for_downsample(64)
                if(best_level >= len(WSI_object.level_dim)): seg_params['seg_level'] = len(WSI_object.level_dim) - 1
                else: seg_params['seg_level'] = best_level

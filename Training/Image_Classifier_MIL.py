...
config['DATA']['N_Per_Sample'] = 10 # for toying around
...
# transforms: hard code them later.
...
# - the tile embedder: type of resnet architecture for the tile embedder.
# - sparse_conv_n_channels_conv1: number of channels of first convolution of the sparse-input CNN pooling
# - sparse_conv_n_channels_conv2: number of channels of second convolution of the sparse-input CNN pooling
# - sparse_map_downsample: downsampling factor of the sparse map
# - wsi_embedding_classifier_n_inner_neurons: number of inner neurons for the WSI embedding classifier
# - n_tiles_per_wsi: number of tiles to be sampled per WSI

# Here the BATCH SIZE should be the number of slides sampled per iteration.
